...
export default function ConfiguratorPage() {
  ...
  if (!mounted) return <div className="min-h-screen flex items-center justify-center">{t('loading')}</div>;
    ...
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8 lg:py-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="w-full lg:w-1/2 sticky top-20 z-30 bg-card/80 backdrop-blur-xl rounded-2xl flex items-center justify-center border shadow-sm h-[280px] sm:h-[350px] lg:h-auto lg:aspect-square transition-all overflow-hidden">
            <div className="relative w-full h-full max-w-[250px] sm:max-w-[300px] lg:max-w-[400px] aspect-square drop-shadow-[0_20px_25px_rgba(0,0,0,0.15)] scale-75 sm:scale-90 lg:scale-100 flex items-center justify-center">
              ...
              {renderOrder.map((category, index) => {
                ...
                // Postupné skládání - vykreslíme jen díly aktuálního nebo předchozích kroků
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            {/* STEPPER HEADER */}
            <div className="flex items-center justify-between bg-card p-3 md:p-4 rounded-xl border shadow-sm z-20">
              <Button 
                variant="ghost" 
                size="icon" 
                onClick={prevStep} 
              ...
              <div className="text-center flex-1">
                <p className="text-xs md:text-sm text-muted-foreground uppercase tracking-widest font-semibold mb-0.5 md:mb-1">
                  {t('step')} {currentStepIndex + 1} / {configuratorData.length}
                </p>
                    ...
                    <CardContent className="p-5 flex flex-col h-full relative">
                      ...
                      <div className="mt-auto">
                        ...
                        <p className="text-sm font-black text-muted-foreground">
                          {option.price > 0 ? `+ ${option.price.toLocaleString("cs-CZ")} Kč` : t('included')}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
