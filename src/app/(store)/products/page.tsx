...
// Mock data
const PRODUCTS = [
  { id: "1", name: "Daydate Blue", price: 5499, type: "Dress", image: "/img/daydate_blue.png" },
  { id: "2", name: "Daydate Blue Textured", price: 5499, type: "Dress", image: "/img/daydate_blue_tex.png" },
  { id: "3", name: "Daydate Green", price: 5499, type: "Dress", image: "/img/daydate_green.png" },
  { id: "4", name: "GMT Coke", price: 5499, type: "GMT", image: "/img/gmt_coke.png" },
];
            ...
            >
              <Card className="overflow-hidden group border-none shadow-sm hover:shadow-xl transition-all duration-500 rounded-2xl bg-card">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground text-sm mb-4">Seiko NH35 Automatic</p>
                </CardContent>
